    ...
    public function run(): void
    {
        ...
        if ($table->count() === 0) {
            $table->insert([
                ...
                ['plano_id' => 6, 'turma_id' => 4],
                ['plano_id' => 6, 'turma_id' => 5],
                ['plano_id' => 7, 'turma_id' => 1],
                ['plano_id' => 7, 'turma_id' => 2],
                ['plano_id' => 7, 'turma_id' => 3],
                ['plano_id' => 7, 'turma_id' => 4],
                ['plano_id' => 8, 'turma_id' => 3],
                ['plano_id' => 8, 'turma_id' => 4],
                ['plano_id' => 8, 'turma_id' => 6],
                ['plano_id' => 9, 'turma_id' => 1],
                ['plano_id' => 9, 'turma_id' => 2],
                ['plano_id' => 9, 'turma_id' => 3],
                ['plano_id' => 9, 'turma_id' => 4],
                ['plano_id' => 9, 'turma_id' => 5],
                ['plano_id' => 9, 'turma_id' => 6],
            ]);
        }
    }
}
